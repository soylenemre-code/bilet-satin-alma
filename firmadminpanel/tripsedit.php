...
<table>
  ...
  <tbody>
    <?php
   $stmt = $db->prepare("SELECT User.full_name, Booked_Seats.seat_number, Tickets.created_at FROM Tickets JOIN User ON Tickets.user_id = User.id JOIN Booked_Seats ON Booked_Seats.ticket_id = Tickets.id
