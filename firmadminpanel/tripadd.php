...
if (!isset($_SESSION['company_id'])) {
    $error = "Sefer oluşturmak için önce giriş yapmalısınız.";
} else {
    $company_id = $_SESSION['company_id']; 
    $departure_city = $destination_city = $arrival_time = $departure_time = $price = $capacity = '';
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (!$departure_city || !$destination_city || !$arrival_time || !$departure_time || !$price || !$capacity) {
            ...
            if ($arrival_timestamp < $current_timestamp || $departure_timestamp < $current_timestamp) {
